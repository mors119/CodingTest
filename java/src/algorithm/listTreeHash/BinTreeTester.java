...
// javac algorithm/listTreeHash/BinTreeTester.java
// java algorithm/listTreeHash/BinTreeTester
...
public class BinTreeTester {
  ...
  public static void main(String[] args) {
    ...
    BinTree<Integer, Data> tree = new BinTree<Integer, Data>(); // 이진 검색 트리를 생성
